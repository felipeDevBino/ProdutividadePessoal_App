...
public class InterfaceGrafica {
	...
	private void initialize() {
		...
		btnNewButton_5.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				for(String entretenimento : Entretenimentos.entretenimentos.keySet()) {
					JOptionPane.showMessageDialog(null, entretenimento, "Entretenimento " + (contador + 1), JOptionPane.INFORMATION_MESSAGE);
					TempoEmEntretenimentos.incrementaTempo(TempoEmAtividades.horasAcumuladas, TempoEmAtividades.minutosAcumulados, TempoEmAtividades.segundosAcumulados);
					contador++;
				}
			}
		});
		...
		JLabel lblNewLabel_7 = new JLabel("tempo entrete");
		lblNewLabel_7.setBounds(182, 242, 89, 14);
